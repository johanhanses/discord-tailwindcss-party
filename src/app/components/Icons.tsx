...
export function VerifiedIcon(props: ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
      aria-label="Verified"
      aria-hidden="false"
...
export function SpeakerphoneIcon(props: ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
      viewBox="0 0 24 24"
      {...props}
...
export function ArrowComponent(props: ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
      viewBox="0 0 24 24"
      {...props}
...
export function AddPersonIcon(props: ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
      viewBox="0 0 16 16"
      {...props}
...
export function HashtagIcon(props: ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
      viewBox="0 0 24 24"
      {...props}
